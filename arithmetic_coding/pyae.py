...
def get_encoded_value(last_stage_probs):
    ...
    Returns the minimum and maximum probabilities
    in the last stage in addition to the value encoding the message.
    """
...
def process_stage(probability_table, stage_min, stage_max):
    ...
    stage_min: The minimum probability of the current stage.
...
class ArithmeticEncoding:
    ...
    def __init__(self, frequency_table, save_stages=False):
        ...
        self.probability_table = get_probability_table(frequency_table)
    ...
    def encode(self, msg, probability_table):
        ...
        and the maximum and minimum values of the interval in which the floating-point value falls.
        """
