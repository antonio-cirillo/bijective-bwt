...
def bbwt_m2f_rle_lzw(file_path: str, file_name: str, alphabet: list[str]) -> str:
    # open and read file
    ...
    for chunk in [m2f_decoded[i:i + CHUNK_SIZE]
        ...
        write_decompressed_file(DECOMPRESSED_LZW_DIR_PATH, compressed_file_name, bbwt_decoded_chunk)
